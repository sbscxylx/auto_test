...
class TestIEMSUser(unittest.TestCase):
    ...
    def test_01_open_user(self):
        ...
        IEMSUser(self.driver).user_project('和达高科')
        IEMSUser(self.driver).open_user_a(self.test_user_data[0]['mbrConsName'], self.test_user_data[0]['contacter'], self.test_user_data[0]['contactMobile'])
    ...
    def test_03_recharge_user(self):
        ...
        self.driver.wait_until('x, //*[@id="app"]/div/div[2]/section/div/div[3]/div[1]/div[2]/table/thead/tr/th[4]/div/span[1]/span/span')
        self.driver.move_to_click('x, //*[@id="app"]/div/div[2]/section/div/div[3]/div[1]/div[2]/table/thead/tr/th[4]/div/span[1]/span/span')
        IEMSEquipment(self.driver).select_index(self.test_user_data[0]['mbrConsName'])
        time.sleep(1)
        self.driver.move_to_click('x, //*[@id="app"]/div/div[2]/section/div/div[3]/div[1]/div[5]/div[2]/table/tbody/tr/td[12]/div/div/button[1]')
    ...
    def test_04_refund_user(self):
        ...
        self.driver.wait_until(
            'x, //*[@id="app"]/div/div[2]/section/div/div[3]/div[1]/div[2]/table/thead/tr/th[4]/div/span[1]/span/span')
        self.driver.get_element(
            'x, //*[@id="app"]/div/div[2]/section/div/div[3]/div[1]/div[2]/table/thead/tr/th[4]/div/span[1]/span/span').click()
        IEMSEquipment(self.driver).select_index(self.test_user_data[0]['mbrConsName'])
        time.sleep(1)
    ...
    def test_05_exit_user(self):
        ...
        IEMSEquipment(self.driver).select_index(self.test_user_data[0]['mbrConsName'])
        time.sleep(1)
        # self.driver.wait_play('x, //*[@id="app"]/div/div[2]/section/div/div[2]/div/div[2]/div[8]/div/p')
        # self.driver.wait_display('x, //*[@id="app"]/div/div[2]/section/div/div[2]/div/div[2]/div[8]/div/p')
        mbrConsName = self.driver.get_element(
