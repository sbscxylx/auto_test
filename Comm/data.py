...
class ReadData:
    ...
    def read_csv(self, encoding='utf8'):
        data = []
        file_path = readconfig.ReadConfig().get_file_path("path_name") + '/' + self.file_name
    ...
    def read_excel(self, **kwargs):
        data = []
        file_path = readconfig.ReadConfig().get_file_path("data_path") + '/' + self.file_name
        try:
...
if __name__ == '__main__':
    ...
    # a = ReadData(path.ensure_path_sep("/Results/html/data/test-cases")).read_excel()
    # print(a)